  ...
  render() {
    return (
        ...
        <div>            
            ...
            <div className="homeBlogContactLocationsCareersPayment"><Link to='/'>Home</Link> | Blog | <Link to='/contact'>Contact</Link> | <Link to='/locations'>Locations</Link> | <Link to='/careers'>Careers</Link> | Payment</div>
            <div className="nmlsPrivacyPolicyTermsOfUseDisclosureLicensing">NMLS | Privacy Policy | Terms of Use | Disclosure | Licensing</div>
