...
class Web19201 extends React.Component {
  ...
  render() {
    ...
    return (
          <div data-layer="5bc2967c-43ff-4d2c-8937-4b9f957f4eab" className="web19201">        <div data-layer="7c4b1248-f8d6-467d-a449-f1f8e1716956" className="rectangle108"></div>
        <div data-layer="22844672-c622-4c73-aba5-a001962de300" className="rectangle81"></div>
        <div data-layer="4df4efd5-b3a8-4cb0-beb3-c1642ea4a54a" className="rectangle82"></div>
        <div data-layer="e39e0f7d-00c2-453a-bd60-59dd1e06abee" className="rectangle97"></div>
        <div data-layer="672254bd-1a79-4878-a887-4deb40902e03" className="freedomToChooseTheHomeYouLove"><span className="freedomToChooseTheHomeYouLove-0">Freedom</span><span className="freedomToChooseTheHomeYouLove-7"> to choose the </span><span className="freedomToChooseTheHomeYouLove-22">Home</span><span className="freedomToChooseTheHomeYouLove-26"> you love</span></div>
        ...
        <div data-layer="ec5bc445-350b-46b5-b4df-238fd0868695" className="rectangle92"></div>
        <div data-layer="3da93fce-6612-46e8-86e0-0425ab581f1b" className="rectangle93"></div>
        <div data-layer="e6b4d348-56ca-4ac8-92a5-1a4f91689f6d" className="rectangle94"></div>
        <div data-layer="af93c4ec-fb67-4c21-a98f-4985b29719f5" className="rectangle95"></div>
        <div data-layer="091ee3bc-3394-4920-91e9-a954489fd455" className="component74">            <svg data-layer="acd63fbc-6357-4a27-a320-a600ac41f95f" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path1f3972f84"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="2c92f173-70d2-4f75-9110-5f815a9cc884" className="calculate">Calculate</div>
</div>
        ...
        <div data-layer="f13ab33f-32f2-4254-b683-a0ac67f47755" className="rectangle101"></div>
        <div data-layer="acd9cb2b-faa5-4879-be20-f6daeb2d3c1b" className="rectangle103"></div>
        <div data-layer="0bebebaa-c7bc-4f08-baba-77dc7872b180" className="rectangle102"></div>
        <div data-layer="f3a0375f-0f19-4816-9e75-844111989562" className="rectangle104"></div>
        <div data-layer="73b9d083-d8c5-44bd-9b88-030d43011fc5" className="rectangle105"></div>
        <div data-layer="d880c054-d5ee-428e-966b-c421e5157ea5" className="rectangle106"></div>
        <div data-layer="2a7337c0-0374-48c3-87a4-34a382cb75fb" className="component620">            <svg data-layer="a20edcc9-c489-413b-9fc4-6ec40528ddfd" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path1eae9680b"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="63cfcf97-dcf3-42fa-8d1e-5e81dd212132" className="fromCeo">From CEO</div>
</div>
        <div data-layer="9350907a-3603-4bc3-b4e5-644f09ce026d" className="component621">            <svg data-layer="960b8560-e6de-4542-9611-7e29041a22e7" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path1b238e024"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="31c6d373-3213-421e-a638-2d9ba7e79123" className="holiday">Holiday</div>
</div>
        <div data-layer="3922e185-da8e-4db2-8ee2-32467e7dc7d3" className="component622">            <svg data-layer="fee64601-8e22-4ec5-be57-974732839dc0" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path191e135b0"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="93fed936-2766-46c5-b34f-494f03b876e5" className="market">Market</div>
</div>
        <div data-layer="0013b077-6f5e-4c55-af4d-f76ddbece196" className="component623">            <svg data-layer="8ea16fb7-2e2f-48f6-b084-c94cfe12044d" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path11fb01002"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="6a504ce0-3a53-4fbb-a6f8-aee4c5beb73f" className="realEstate">Real Estate</div>
</div>
        <div data-layer="d359aadd-7163-480a-b8e6-b4c35694f630" className="component624">            <svg data-layer="4d923eeb-3244-4fac-a8a5-767fad93b445" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path164d77394"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="f2c117e5-6bcb-4104-bac5-f99526c275fe" className="resources">Resources</div>
</div>
        <div data-layer="1528c829-7ba8-44d9-ad53-3ee47bf9e9a2" className="component625">            <svg data-layer="6c8a0aeb-da97-427d-b091-76160f9586e4" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path1bb7d2e1c"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="f888aa65-ed1e-4e98-abfb-9922ca2f3071" className="spotlight">Spotlight</div>
</div>
        <div data-layer="a214cf21-fb85-4c45-97e8-97c43c559a2c" className="component626">            <svg data-layer="fb077376-b4de-47d1-bea6-36527893b1b9" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path189720d44"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="760f731b-1dbe-4fb9-bcb6-45b26d3143fc" className="technology">Technology</div>
</div>
        <svg data-layer="b6b16d65-8bd7-4b1f-8c4b-e84abcac0b04" preserveAspectRatio="none" viewBox="0 -1.5 1591 3" className="line13"><path d="M 0 0 L 1591 0"  /></svg>
        <div data-layer="1813dcf6-bbdd-4dea-93c2-f1b792593356" className="commonMortgageTermsExplained">Common Mortgage Terms Explained</div>
        <div data-layer="852fdfe4-75dd-4ecb-a099-af620e3a08ef" className="theSpringMarketHasSprung">The Spring Market has Sprung</div>
        <div data-layer="9a623fea-fb45-4aa4-ba6b-e993d57d31e2" className="theRoaring20sMoneyMachine">The Roaring 20’s Money Machine</div>
        <svg data-layer="28d492a4-378e-4a35-b442-dde815c193e6" preserveAspectRatio="none" viewBox="0 0 61 61" className="ellipse23"><defs><pattern id="img-ellipse23" patternContentUnits="userSpaceOnUse" width="100%" height="100%"><image xlinkHref={require('./assets/ellipse23.png')} x="0" y="0" width="61.00px" height="61.00px" /></pattern></defs><path d="M 30.5 0 C 47.34468078613281 0 61 13.65531730651855 61 30.5 C 61 47.34468078613281 47.34468078613281 61 30.5 61 C 13.65531730651855 61 0 47.34468078613281 0 30.5 C 0 13.65531730651855 13.65531730651855 0 30.5 0 Z" fill="url(#img-ellipse23)" /></svg>
        <svg data-layer="cbf4e7d3-3ceb-4240-9aa2-7b85857bffc5" preserveAspectRatio="none" viewBox="0 0 61 61" className="ellipse24"><defs><pattern id="img-ellipse24" patternContentUnits="userSpaceOnUse" width="100%" height="100%"><image xlinkHref={require('./assets/ellipse24.png')} x="0" y="0" width="61.00px" height="61.00px" /></pattern></defs><path d="M 30.5 0 C 47.34468078613281 0 61 13.65531730651855 61 30.5 C 61 47.34468078613281 47.34468078613281 61 30.5 61 C 13.65531730651855 61 0 47.34468078613281 0 30.5 C 0 13.65531730651855 13.65531730651855 0 30.5 0 Z" fill="url(#img-ellipse24)" /></svg>
        <svg data-layer="97b43177-e420-4e98-9e87-f13527acdd99" preserveAspectRatio="none" viewBox="0 0 61 61" className="ellipse25"><defs><pattern id="img-ellipse25" patternContentUnits="userSpaceOnUse" width="100%" height="100%"><image xlinkHref={require('./assets/ellipse25.png')} x="0" y="0" width="61.00px" height="61.00px" /></pattern></defs><path d="M 30.5 0 C 47.34468078613281 0 61 13.65531730651855 61 30.5 C 61 47.34468078613281 47.34468078613281 61 30.5 61 C 13.65531730651855 61 0 47.34468078613281 0 30.5 C 0 13.65531730651855 13.65531730651855 0 30.5 0 Z" fill="url(#img-ellipse25)" /></svg>
        <div data-layer="221c4da7-fab6-456a-8f0c-e8365650c799" className="authorapril192019">Author<br />April 19, 2019        </div>
        <div data-layer="87fd3a3a-98b1-49b2-9bfc-7c43aa8c5816" className="authorapril242018">Author<br />April 24, 2018        </div>
        <div data-layer="75347a98-de68-4d6f-97a6-9e7f53d224d5" className="authorjanuary102020">Author<br />January 10, 2020        </div>
        <div data-layer="66dcce9f-fe21-4fe5-b476-071fd4fefefa" className="loremIpsumDolorSitAmetConseteturSadipscingElitrSedDiamNonumyEirmodTemporInviduntUtLaboreEtDoloreMagnaAliquyamEratSedDiamVoluptuaAtVeroEosEtAccusamEtJustoDuoDoloresEtEaRebumStetClitaKasdGubergrenNoSeaTakimata44f534eb">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est.</div>
        <div data-layer="ecebeeae-1190-45eb-88cc-a42dbf4d71fe" className="loremIpsumDolorSitAmetConseteturSadipscingElitrSedDiamNonumyEirmodTemporInviduntUtLaboreEtDoloreMagnaAliquyamEratSedDiamVoluptuaAtVeroEosEtAccusamEtJustoDuoDoloresEtEaRebumStetClitaKasdGubergrenNoSeaTakimata1cc9e289">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est.</div>
        <div data-layer="b3b64a60-a8cc-4701-a4fd-66350fe1ca49" className="loremIpsumDolorSitAmetConseteturSadipscingElitrSedDiamNonumyEirmodTemporInviduntUtLaboreEtDoloreMagnaAliquyamEratSedDiamVoluptuaAtVeroEosEtAccusamEtJustoDuoDoloresEtEaRebumStetClitaKasdGubergrenNoSeaTakimata">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est.</div>
        <div data-layer="3f085518-c033-4354-85dd-ce454e7924e0" className="rectangle96"></div>
        <div data-layer="80731bd3-17fe-4a50-ab9b-691f67af8dd8" className="aFreshLookAtYourHome">A fresh look at your home</div>
        <div data-layer="1ed34e77-c88a-4d34-8df2-22fc982ccdb4" className="rectangle110"></div>
        <div data-layer="ffa322ed-cc8c-4119-acdc-7a7ee16b702e" className="rectangle113"></div>
        <div data-layer="d73d1461-d845-4067-982f-61fa3e16b59d" className="foundThePerfectHomeOrInTheHomeYouLove"><span className="foundThePerfectHomeOrInTheHomeYouLove-0">Found the </span><span className="foundThePerfectHomeOrInTheHomeYouLove-10">Perfect</span><span className="foundThePerfectHomeOrInTheHomeYouLove-17"> home <br />or in the home you </span><span className="foundThePerfectHomeOrInTheHomeYouLove-43">Love</span></div>
        <svg data-layer="f4225ed3-0638-44f1-9ba2-78afffba88bc" preserveAspectRatio="none" viewBox="0 -1.5 1591 3" className="line15"><path d="M 0 0 L 1591 0"  /></svg>
        <div data-layer="58612efe-9dfe-463e-b3da-e450de2a6ecb" className="component627">            <svg data-layer="e86adc74-5fff-4e43-92d4-b23e8ee4d357" preserveAspectRatio="none" viewBox="-1.5 -1.5 178 69" className="path1"><path d="M 0 0 L 175 0 L 175 66 L 0 66 L 0 0 Z"  /></svg>
            <div data-layer="aabdbfd6-448f-456f-aa42-a04ff555db33" className="startNow">Start Now</div>
</div>
        ...
        <div data-layer="00954afc-6833-44b6-871c-925a160a0b93" className="rectangle109"></div>
        <div data-layer="6942b21c-d601-4c30-b744-6f7943a9fd8a" className="group5">            <div data-layer="941cc0a4-1f51-46ed-bfc7-ccac2daad453" className="rectangle64"></div>
            <div data-layer="f3da8b79-265d-4abe-a13b-dd989de9635c" className="rectangle65"></div>
            <div data-layer="9e1d0a59-03a1-403f-a74d-a9facf1340bc" className="rectangle66"></div>
</div>
        <div data-layer="46e37bca-30b5-4fed-92a4-08d5f838be3b" className="homeBlogContactLocationsCareersPayment">Home | Blog | Contact | Locations | Careers | Payment</div>
        <div data-layer="0f9402e7-c724-4302-a06f-1050ef12d325" className="nmlsPrivacyPolicyTermsOfUseDisclosureLicensing">NMLS | Privacy Policy | Terms of Use | Disclosure | Licensing</div>
        <div data-layer="d7a37be9-be1e-4db2-82bd-46f1f6105021" className="x2021PlatinumHomeMortgageCorporationAllRightsReservedLegalLicensingPrivacyInNewYorkDbaPhmcMortgageNmlsId">© 2021 Platinum Home Mortgage Corporation. All rights reserved. Legal | Licensing | Privacy In New York: dba PHMC Mortgage NMLS ID #13589. For licensing information, go to: www.nmlsconsumeraccess.org All loans subject to credit approval and certain restrictions may apply. Information subject to change without notice. HomeStyle® is a registered trademark of Fannie Mae.</div>
        <div data-layer="bf9ca279-fd20-4361-b3dc-0e8260ccf9a6" className="rectangle111"></div>
        <div data-layer="a7755939-e087-42f5-80d8-f9d5a1f78698" className="rectangle112"></div>
        <svg data-layer="7bf87e16-debd-4d33-a7f6-df3d67d9beab" preserveAspectRatio="none" viewBox="0 -0.5 1560 1" className="line14"><path d="M 0 0 L 1560 0"  /></svg>
        <div data-layer="4ea8830b-e94c-484d-b3d5-a26bbba5ae73" className="rectangle115"></div>
        <div data-layer="ddb15883-f421-4350-8c77-0a9b23f45ad6" className="platinumlogohorizontal"></div>
        <div data-layer="27e9190a-65bc-4b67-8766-8b4670640d4c" className="rectangle107"></div>
        <div data-layer="5bd0ad1b-031a-44f0-b50f-428334eab5b1" className="whatPeopleAreSaying">What people are saying</div>
</div>
