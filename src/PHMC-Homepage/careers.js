...
export default class Careers extends Component {
  ...
  render() {
    ...
    <ScrollView data-layer="02527852-5a3b-4733-9491-a3022c6b1627" style={styles.careers}>
        ...
        <Text data-layer="b7ea849c-abcd-4fa5-b4ff-dc3442d4aa65" style={styles.careers_careers70d32632}>Careers</Text>
        <Text data-layer="d664b993-bbf9-4ba1-9adc-fa44f521dda4" style={styles.careers_contact}>Contact</Text>
        <Text data-layer="cfe5934b-f3b8-4f60-ae76-2e3b427de92b" style={styles.careers_locations}>Locations</Text>
        <Text data-layer="f15e4630-bcda-4d18-9a2b-ce801cfccb5b" style={styles.careers_payment}>Payment</Text>
        ...
        <ReactImage data-layer="6bb15713-0783-49f5-b40c-0c78ff0cf564" source={require('../assets/careers/rectangle6.png')} style={styles.careers_rectangle6} />
