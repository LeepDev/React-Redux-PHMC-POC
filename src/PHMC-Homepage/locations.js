...
class Locations extends React.Component {
  ...
  render() {
    ...
    return (
        <div data-layer="7943cd2d-ca72-4ea8-8e01-0d662dfcbc22" className="locations">
        ...
        <div data-layer="a1ebe026-750b-4a58-841e-e2080c7c4647" className="component611">            <svg data-layer="b42559ef-c10a-4973-96d5-bfe0b4ad47d8" preserveAspectRatio="none" viewBox="-1.5 -1.5 316.6015625 69" className="path1"><path d="M 0 0 L 313.6015625 0 L 313.6015625 66 L 0 66 L 0 0 Z"  /></svg>
